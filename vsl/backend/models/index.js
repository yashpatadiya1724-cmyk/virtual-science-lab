 ...
 * User, Experiment, Session, Progress, Analytics, School
 */
'use strict';
...
const ExperimentSchema = new Schema({
  ...
  ncertChapter: String,
  objectives:   [String],
  steps:        [{ order:Number, instruction:String, hint:String }],
...
const AnalyticsSchema = new Schema({
  eventType:    { type:String, enum:['session_start','session_end','step_complete','experiment_complete','vr_enter','vr_exit','error'], required:true },
